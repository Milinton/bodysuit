...
global.bucin = ["Envia un mensaje a tu ex y dile Todavia me gustas", "Envia un audio diciendo amo a FG98, si eres mujer :v", 
"dile a tu crush que la amas y pasar cap en el grupo", "Envia un audio cantando", 
"Envia tu foto sin taparte la cara", "Envia un video bailando", 
"Invita a personas que no conoces a tomarse una selfie contigo y luego envíalo al grupo", 
"Elija algunos números aleatorios de sus contactos y envíeles un mensaje de texto con el mensaje 'Estoy embarazada'.", 
...
"bromea charlar con ex y decir 'te amo, por favor vuelve' sin atreverse!", 
" chatee para ponerse en contacto con wa en el orden de acuerdo con su% de batería, luego dígale '¡tengo suerte de contar con usted!' ", 
"cambiar el nombre a 'Soy un hijo FG' durante 5 horas", 
"¡Diga 'USTED ES TAN HERMOSO NO MIENTO' a los chicos!"
